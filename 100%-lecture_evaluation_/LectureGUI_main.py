...
def reg():
    from subprocess import call
    call(["python",r'C:\Users\hrish\OneDrive\Desktop\100%-lecture_evaluation_Shital Code\100%-lecture_evaluation_Shital Code\lecture_registration.py'])

def log():
    from subprocess import call
    call(["python",r'C:\Users\hrish\OneDrive\Desktop\100%-lecture_evaluation_Shital Code\100%-lecture_evaluation_Shital Code\lecture_login.py'])
