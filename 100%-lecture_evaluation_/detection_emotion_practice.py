...
def upload():
    ...
    face_cascade = cv2.CascadeClassifier(r'C:\Users\hrish\OneDrive\Desktop\100%-lecture_evaluation_Shital Code\100%-lecture_evaluation_Shital Code\haarcascade_frontalface_default.xml')
    face_smile = cv2.CascadeClassifier(r'C:\Users\hrish\OneDrive\Desktop\100%-lecture_evaluation_Shital Code\100%-lecture_evaluation_Shital Code\haarcascade_smile.xml')

    #faceDet_two = cv2.CascadeClassifier("9185481.xml")
    faceDet_two = cv2.CascadeClassifier(r'C:\Users\hrish\OneDrive\Desktop\100%-lecture_evaluation_Shital Code\100%-lecture_evaluation_Shital Code\haarcascade_frontalface_alt2.xml')
    faceDet_three = cv2.CascadeClassifier(r'C:\Users\hrish\OneDrive\Desktop\100%-lecture_evaluation_Shital Code\100%-lecture_evaluation_Shital Code\haarcascade_frontalface_alt.xml')
    #faceDet_three = cv2.CascadeClassifier("haarcascade_smile.xml")
    faceDet_four = cv2.CascadeClassifier(r'C:\Users\hrish\OneDrive\Desktop\100%-lecture_evaluation_Shital Code\100%-lecture_evaluation_Shital Code\haarcascade_frontalface_alt_tree.xml')
    ...
    ###########################################################################################################
        ...
        for (x, y, w, h) in faces:
            if fear in faces:
                ...
                cv2.imwrite(r'C:\Users\hrish\OneDrive\Desktop\100%-lecture_evaluation_Shital Code\100%-lecture_evaluation_Shital Code\dataset\dataset\fear' + str(value) + "." + str(sampleNum) + ".jpg", gray[y:y + h, x:x + w])
    ...
    ###############################################################################################################            #cv2.waitKey(1);
                ...
                sampleNum = sampleNum + 1
                cv2.imwrite(r'C:\Users\hrish\OneDrive\Desktop\100%-lecture_evaluation_Shital Code\100%-lecture_evaluation_Shital Code\dataset\dataset\happy' + str(value) + "." + str(sampleNum) + ".jpg", gray[y:y + h, x:x + w])
                cv2.rectangle(img, (x, y), (x + w, y + h), (255, 0, 0), 1)
    ...
    ###########################################################################################################        #cv2.waitKey(1);
                ...
                sampleNum = sampleNum + 1
                cv2.imwrite(r'C:\Users\hrish\OneDrive\Desktop\100%-lecture_evaluation_Shital Code\100%-lecture_evaluation_Shital Code\dataset\dataset\neutral' + str(value) + "." + str(sampleNum) + ".jpg", gray[y:y + h, x:x + w])
                cv2.rectangle(img, (x, y), (x + w, y + h), (255, 0, 0), 1)
    ...
    ###########################################################################################################        #cv2.waitKey(1);
                ...
                sampleNum = sampleNum + 1
                cv2.imwrite(r'C:\Users\hrish\OneDrive\Desktop\100%-lecture_evaluation_Shital Code\100%-lecture_evaluation_Shital Code\dataset\dataset\sad' + str(value) + "." + str(sampleNum) + ".jpg", gray[y:y + h, x:x + w])
                cv2.rectangle(img, (x, y), (x + w, y + h), (255, 0, 0), 1)
...
def files_count():
    ...
    happy = r'C:\Users\hrish\OneDrive\Desktop\100%-lecture_evaluation_Shital Code\100%-lecture_evaluation_Shital Code\dataset\dataset\happy'
    ...
    fear = r'C:\Users\hrish\OneDrive\Desktop\100%-lecture_evaluation_Shital Code\100%-lecture_evaluation_Shital Code\dataset\dataset\fear'
    ...
    sad = r'C:\Users\hrish\OneDrive\Desktop\100%-lecture_evaluation_Shital Code\100%-lecture_evaluation_Shital Code\dataset\dataset\sad'
    ...
    neutral = r'C:\Users\hrish\OneDrive\Desktop\100%-lecture_evaluation_Shital Code\100%-lecture_evaluation_Shital Code\dataset\dataset\neutral'
    ...
    if int(number_of_Happy_files) > int(number_of_Fear_files) and int(number_of_Happy_files) > int(number_of_sad_files) and int(number_of_Happy_files) > int(number_of_neutral_files):
        ...
        str_label = "Lecture Evaluation is = 60% and Lecture Was Good "
        print(str_label)
